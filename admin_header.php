...
<html lang="zxx">
<head>
<title>Prezzie an Ecommerce Online Shopping Category Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- custom-theme -->
		...
		<div class="center-container">
			<div class="w3_agile_header">
						<div class="w3_agileits_logo">
								<h1><a href="index.php">prezzie<span>Life is a gift</span></a></h1>
							</div>
							<div class="w3_menu">
								...
								<nav class="navbar navbar-default">
									...
									<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav">
											...
											<li><a href="about.php" class="active">Category</a></li>
											<li><a href="gallery.php">Product</a></li>
